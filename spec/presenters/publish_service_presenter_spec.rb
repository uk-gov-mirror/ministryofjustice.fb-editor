    ...
    context 'when there is a published service' do
      context 'when same deployment_environment' do
        ...
        it 'returns hostname link' do
          expect(hostname).to eq(%{<a target=\"_blank\" class=\"govuk-link\" href=\"https://service-name.dev.test.form.service.justice.gov.uk\">service-name.dev.test.form.service.justice.gov.uk</a>})
        end
      end
